...
function Features() {
    return (
        ...
        <section className="features-background">
            ...
            <h2 className="features-container-info" >Why choose Easybank?</h2>
            <h3 className="featuresInfo">We leverage Open Banking to turn your bank account into your financial hub. Control
  your finances like never before.</h3>

            <div className="features-container">
                <div className="features-container-info">
